...
const About = (props) => {
    ...
    <h5>The purpose of this app is to allow users to navigate top stocks data. Click on "Dashboard" to start browsing stocks or check out the resources below for more details on the project.</h5>
    <ul>
